...
class Config:
	...
	def __init__(self) -> None:
		...
		self.commits_ccs_dsd2 = ["Cn-" + str(i + 1) for i in range(49)]
		self.commits_ccs_dsd3 =  ["Cn-" + str(i + 1) for i in range(50)]
		self.time_in_sec = "Time (seconds)"
		self.font_family = "font.family"
		self.text_color = "text.color"
		self.axes_labelcolor = "axes.labelcolor"
		self.xtick_color = "xtick.color"
		self.ytick_color = "ytick.color"
		self.ABD_n = 5
		self.DSD_n = 50
		self.random_state = 4
		self.test_size = 0.2
